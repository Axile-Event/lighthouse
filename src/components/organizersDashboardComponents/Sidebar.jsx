      ...
      <aside className="hidden md:flex flex-col w-64 h-screen bg-black border-r border-gray-900 text-white px-6 py-8 fixed left-0 top-0">
        ...
        <nav className="flex-1 flex flex-col gap-3">
          {OrganizationDashboardNavLinks.map((link) => (
            ...
            >
              {cloneElement(link.icon, { size: 20, strokeWidth: 2 })}
        ...
        <div className="space-y-3">
          ...
          <button 
            ...
            className="p-2 hover:bg-red-500/10 rounded-lg font-bold flex gap-3 items-center text-red-500 cursor-pointer w-full text-left transition-all duration-300"
          >
